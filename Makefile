...
MODULES=ast type lexer common genxml parser typecore optimizer typeload \
	...
	genswf9 genswf genjava gencs genpy genobjc interp dce analyzer filters typer matcher version main
...
genobjc.$(MODULE_EXT): type.$(MODULE_EXT) lexer.$(MODULE_EXT) common.$(MODULE_EXT) codegen.$(MODULE_EXT) ast.$(MODULE_EXT)
